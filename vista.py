...
class MainWindow():
    ...
    def procesar(self):
        try:
            ...
            self.new_model.leer_excel(archivo, directorio, rg)
    ...
    def formulario_acerca(self):
        ...
        self.btn_linkedin = QtWidgets.QPushButton(frm_acerca, 
                            clicked = lambda: webbrowser.open("http://www.linkedin.com/in/jorge-e-arrieta", 
                            new=2, 
                            autoraise=True))
        self.btn_linkedin.setGeometry(QtCore.QRect(190, 100, 75, 23))
        ...
        self.lbl_1.setText(_translate("frm_acerca", "Escalas actualizadas al 20/01/2022"))
        ...
        self.btn_linkedin.setText(_translate("frm_acerca", "LinkedIn"))
